<template>
	<view class="tui-container" @touchmove.stop.prevent="stop">
		...
		<view class="tui-cropper-tabbar" v-if="!custom">
			<view class="tui-op-btn" @click.stop="back">取消</view>
			<image :src="rotateImg" class="tui-rotate-img" @click="setAngle"></image>
			<view class="tui-op-btn" @click.stop="getImage">完成</view>
		</view>
	</view>
</template>
