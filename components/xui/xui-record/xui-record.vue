<template>
	<view  class="jsfun-record" @click="showPicker">
	 <slot></slot>
	 <!-- 遮罩层 -->
	 <view class="mask" @click.stop="closePicker" v-if="isShow" @touchmove.stop.prevent="moveHandle"></view>
	 <!-- 多选控件 -->
	 <view class="conbox record" :class="{'pickerShow':isShow}" >
		...
		<view class="record-box">
			<span class="stop" @click.stop="stopVoice" v-if="_voicePath && playing==1"></span>
			<span class="paly" @click.stop="playVoice" v-if="_voicePath && playing==0"></span>
			...
			<span class="confirm" @click.stop="okClick" v-if="_voicePath"></span>
		</view>
