<template>
    <view class="vue-cropper" ref="cropper" :style="{ top : `${containerTop}px` }" v-show="show">
        ...
        <view class="btn-group">
            <view class="btn-item reset-btn" v-show="showResetBtn" @click="init"></view>
            <view class="btn-item rotate-btn" v-show="showRotateBtn" @click="rotateHandler"></view>
        </view>

        <view class="uni-info__ft">
            <view class="uni-modal__btn uni-modal__btn_default" style="color: rgb(0, 0, 0);" @click="cancel">取消</view>
            <view class="uni-modal__btn uni-modal__btn_primary" style="color: rgb(0, 122, 255);" @click="confirm">确定</view>
        </view>
    </view>
</template>
