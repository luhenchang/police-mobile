		...
		<view class=" page-margin-bottom">
			<view class="pannel-white mb10">
				...
				<view class="line"> <text class="label">通报类型：</text><text class="text">{{detail.isFenju==1?'分局通报':''}} {{detail.isSuo==1?'派出所通报':''}}</text></view>
					...
					<view class="line"> <text class="label">临期时间：</text><text class="text">{{detail.nearTime}}</text></view>
					<view class="line"> <text class="label">超期时间：</text><text class="text">{{detail.beyondTime}}</text></view>
					...
					<view class="line"> <text class="label">具体问题：</text></view>
			...
			<view class="pannel-white mb10">
					<view class="line"> <text class="label big">派出所整改情况：</text><text class="text">{{detail.reactResult}}</text></view>
